var projectName = '学生综合成绩测评系统的设计与实现';
/**
 * 轮播图配置
 */
var swiper = {
...
var menu = [{
    "backMenu": [{
        ...
        "child": [{
            ...
            "menu": "轮播图管理",
            "tableName": "config"
        }, {"appFrontIcon": "cuIcon-news", "buttons": ["新增", "查看", "修改", "删除"], "menu": "校园资讯", "tableName": "news"}],
        "menu": "系统管理"
    }],
    "frontMenu": [{
        "child": [{
    ...
    "backMenu": [{
        ...
        "child": [{"appFrontIcon": "cuIcon-rank", "buttons": ["查看", "删除"], "menu": "留言板管理", "tableName": "messages"}],
        "menu": "留言板管理"
    }],
    "frontMenu": [{
        "child": [{
