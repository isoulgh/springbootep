...
const routes = [{
    path: '/index', name: '首页', component: Index, children: [{
        // 这里不设置值，是把main作为默认页面
        path: '/', name: '首页', component: Home, meta: {icon: '', title: 'center'}
    }, {
        ...
        path: '/news', name: '校园资讯', component: news
    }, {
        path: '/banjijianyi', name: '班级建议', component: banjijianyi
    }, {
        path: '/jiangxuejintijiao', name: '奖学金提交', component: jiangxuejintijiao
    }, {
        path: '/xuesheng', name: '学生', component: xuesheng
    }, {
        path: '/xuefenjianyi', name: '学分建议', component: xuefenjianyi
    }, {
        path: '/kechengchengji', name: '课程成绩', component: kechengchengji
    }, {
        path: '/ketangdianming', name: '课堂点名', component: ketangdianming
    }, {
        path: '/jiaoshi', name: '教师', component: jiaoshi
    }, {
        path: '/jiafentijiao', name: '加分提交', component: jiafentijiao
    }, {
        path: '/kechengxinxi', name: '课程信息', component: kechengxinxi
    }, {
        path: '/forum', name: '论坛交流', component: forum
    }, {
        path: '/jiafenshenqing', name: '加分申请', component: jiafenshenqing
    }, {
        path: '/tongzhigonggao', name: '通知公告', component: tongzhigonggao
    }, {
        path: '/messages', name: '留言板管理', component: messages
    }, {
        path: '/jiangxuejinshenqing', name: '奖学金申请', component: jiangxuejinshenqing
    }, {
        path: '/config', name: '轮播图管理', component: config
    }, {
        path: '/biyeyaoqiu', name: '毕业要求', component: biyeyaoqiu
    }, {
        path: '/yiqingdaka', name: '疫情打卡', component: yiqingdaka
    }]
}, {
