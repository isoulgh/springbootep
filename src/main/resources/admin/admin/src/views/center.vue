  ...
  <div>
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item v-if="flag=='xuesheng'" label="身份" prop="shenfen">
            <el-select v-model="ruleForm.shenfen" :disabled="true" placeholder="请选择身份">
              <el-option
                  v-for="(item,index) in xueshengshenfenOptions"
                  v-bind:key="index"
                  :label="item"
                  :value="item">
              </el-option>
        ...
        <el-col :span="12">
          <el-form-item v-if="flag=='xuesheng'" label="教师账号" prop="jiaoshizhanghao">
            <el-select @change="xueshengjiaoshizhanghaoChange" :disabled="true" v-model="ruleForm.jiaoshizhanghao"
                       placeholder="请选择教师账号">
              <el-option
...
export default {
  ...
  mounted() {
    ...
    this.xueshengshenfenOptions = "班长,普通学生".split(',')
    this.$http({
